...
// ===========================================================================
// Vault 0xd11c Donation Attack PoC
//
// @KeyInfo
// Vault Address: 0xD11c452fc99Cf405034ee446803b6f6c1f6d5ed8
// Deploy Block: 20,711,118
// Lending Platform: Aave v3, Aave Lido, Compound v3 (3 platforms)
//
// @AttackType
...
// 这是一个多平台 vault，需要验证其 accounting 机制
// ===========================================================================
...
contract Vault_0xd11c_DonationPoC is BaseTestWithBalanceLog {
    // === 地址常量 ===
    IERC4626Vault internal constant VAULT = IERC4626Vault(0xD11c452fc99cF405034ee446803b6F6c1F6d5ED8);
    
    // === Fork 区块 - 部署区块 ===
    uint256 internal constant DEPLOY_BLOCK = 20_711_118;
    ...
    function testFullAttackFlow() public balanceLog {
        ...
        emit log_string("=== Multi-Platform Vault (Aave v3, Aave Lido, Compound v3) ===");
        emit log_string("============================================================");
        emit log_named_uint("Fork Block", actualForkBlock);
